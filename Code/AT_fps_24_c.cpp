...
// URL: https://atcoder.jp/contests/fps-24/tasks/fps_24_c
// Memory Limit: 1024 MB
// Time Limit: 2000 ms
// Written by yhm.
// Start codeing:2025-11-13 19:02:08
// 
...
vector<int> ksm(vector<int> a,int b){
	vector<int> ans={1};
	while(b){
		if(b&1)ans=poly::mul(ans,a),ans.resize(s+1);
		a=poly::mul(a,a),a.resize(s+1);
		b>>=1;
	}
	return ans;
}
