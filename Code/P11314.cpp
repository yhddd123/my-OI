// Problem: P11314 [RMI 2021] 礼物 / Present
// Contest: Luogu
// URL: https://www.luogu.com.cn/problem/P11314
// Memory Limit: 500 MB
// Time Limit: 4000 ms
// Written by yhm.
// Start codeing:2025-05-29 15:28:29
// 
...
void work(){
	...
	vector<int> ans;
	for(int i=1;i<=37;i++)if(s&(1ll<<i))ans.push_back(i);
	printf("%d ",ans.size());for(int i:ans)printf("%d ",i);puts("");
}
