// Problem: AT_fps_24_a お菓子
// Contest: Luogu
// URL: https://www.luogu.com.cn/problem/AT_fps_24_a
// Memory Limit: 1024 MB
// Time Limit: 2000 ms
// Written by yhm.
// Start codeing:2025-11-13 18:53:43
// 
...
void work(){
	n=read();m=read()-n;
	if(m<0||m>5*n){puts("0");return ;}
	vector<int> f={1,0,1,1,0,1};
	f=ksm(f,n);
	printf("%lld\n",f[m]);
}
